...
<div class="row" ><!-- row no: 1 begin -->
    <div class="col-sm-12"><!-- col-sm-12 begin -->
        ...
        <ol class="alert alert-danger"><!-- breadcrumb begin -->
<!-- A breadcrumb navigation provide links back to each previous page the user navigated through, and shows the user's current location in a website -->
            <li class="active"><!-- active begin -->
                ...
                <i class="fa fa-dashboard" style="font-size:48px;color:red"></i> Dashboard
...
<!--==============================first primary product panle is statr=========================== --> 
<div class="row"><!-- row no: 2 begin creating row  -->
   
    <div class="col-lg-3 col-lg-6"><!-- col-lg-3 col-md-6 begin -->
        <div class="panel panel-primary"><!-- panel panel-primary begin -->
   <!-- panel panel-primary begin this panel is display in BLUE COLOR -->         
            <div class="panel-heading"><!-- panel-heading begin -->
                <div class="row"><!-- panel-heading row begin -->
                    <div class="col-xs-3"><!-- col-xs-3 begin -->
                       
                        <i class="fa fa-tasks fa-5x" style="color:red"></i>
            ...
            <a href="index.php?view_products"><!-- a href begin -->
                <div class="panel-footer"><!-- panel-footer begin -->
                    ...
                    <span class="pull-right"><!-- pull-right begin arrow icon is deplay--> 
        ...
        <div class="panel panel-primary"><!-- panel panel-primary begin -->
            <div class="panel-heading"><!-- panel-heading begin -->
                <h3 class="panel-title"><!-- panel-title begin -->
                    ...
                    <i class="fa fa-money fa-fw"></i> New Orders strat from line 182
