                ...
                <form action="" class="form-horizontal" method="post" enctype="multipart/form-data"><!-- form-horizontal begin -->
                    ...
                    <div class="form-group"><!-- form-group begin -->
                        ...
                        <div class="col-md-6"><!-- col-md-6 begin -->
                            ...
                            <input name="slide_url" type="text" class="form-control" value="<?php echo $slider_url; ?>">
...
<?php  
    ...
    if(isset($_POST['update'])){
        ...
        $update_slide = "update slider set slide_name='$slide_name',slider_url='$slider_url',slide_image='$slide_image' where slide_id='$slide_id'";
