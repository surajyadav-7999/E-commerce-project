    ...
    <div class="col-lg-12"><!-- col-lg-12 begin -->
        <ol class="breadcrumb" style="background-color: Gold;"><!-- breadcrumb begin -->
            <li>
                ...
                <i class="fa fa-dashboard" style="font-size:28px;color:red;"></i> Dashboard / Insert Slide
...
<div class="row"><!-- row 2 begin -->
    <div class="col-lg-12"><!-- col-lg-12 begin -->
        <div class="panel panel-warning"><!-- panel panel-default begin -->
            <div class="panel-heading" style=""><!-- panel-heading begin -->
                <h3 class="panel-title"><!-- panel-title begin -->
                
                    <i class="fa fa-money fa-fw bg-danger"></i> Insert Slide
                ...
                <form action="" class="form-horizontal" method="post" enctype="multipart/form-data"><!-- form-horizontal begin -->
                    ...
                    <div class="form-group"><!-- form-group begin -->
                        ...
                        <div class="col-md-6"><!-- col-md-6 begin -->
                            ...
                            <input type="submit" name="submit" value="Submit Now" class="btn btn btn-warning form-control">
