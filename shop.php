           ...
           <div class="col-md-9"><!-- col-md-9 Begin -->
            ...
            ?>
               ...
               <div class="row"><!-- row Begin -->
                 <?php 
                   #  it is the condistion of desplay the page if number of image more then page is icres the size
             if(!isset($_GET['p_cat'])){
                    if(!isset($_GET['cat'])){
                    $per_page=6; 
                    if(isset($_GET['page'])){
             ...
             <a href='details.php?pro_id=$pro_id'> $pro_title </a>                               
              ...
              <p class='price'>
               ...
               View Details                      
                ...
                <a class='btn btn-primary' href='details.php?pro_id=$pro_id'>                            <i class='fa fa-shopping-cart'></i> Go To Cart</a>
                </p>
                </div>
                </div>
                </div>
...
<!-- ===========================create categris tables============================= -->
                ...
                # increment the page number based on number of imgae
